...
public class ExponentialSmoothing {
	...
	private double b;
	public static ExponentialSmoothing linearRegression;

	public static void main(String[] args) {
		ExponentialSmoothing l = new ExponentialSmoothing();
	...
	public static ExponentialSmoothing getInstance()
	{
		if (linearRegression == null)
			linearRegression = new ExponentialSmoothing();
